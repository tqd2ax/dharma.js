...
var web3_utils_1 = require("./web3_utils");
...
function generateTxOptions(web3, gas, options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, __assign({ gas: gas, from: accounts[0] }, options)];
            }
        });
    });
}
exports.generateTxOptions = generateTxOptions;
