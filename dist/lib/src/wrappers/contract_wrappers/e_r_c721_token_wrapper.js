...
var ERC721TokenContract = /** @class */ (function (_super) {
    ...
    function ERC721TokenContract(web3ContractInstance, defaults) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.safeTransferFrom, self.web3ContractInstance)(_from, _to, _tokenId, _data, txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.safeTransferFrom.getData, self.web3ContractInstance)(_from, _to, _tokenId, _data, txDataWithDefaults)];
                            case 2:
                                abiEncodedTransactionData = _a.sent();
                                return [2 /*return*/, abiEncodedTransactionData];
                        }
    ...
    ERC721TokenContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = contracts_1.ERC721Token.abi, networks = contracts_1.ERC721Token.networks;
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            return [2 /*return*/, new ERC721TokenContract(web3ContractInstance, defaults)];
                        }
                        else {
                            throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("ERC721Token", currentNetwork));
                        }
                        return [3 /*break*/, 4];
                    case 3: throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("ERC721Token", currentNetwork));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    ERC721TokenContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        web3Utils = new web3_utils_1.Web3Utils(web3);
                        abi = contracts_1.ERC721Token.abi;
...
//# sourceMappingURL=e_r_c721_token_wrapper.js.map