...
var SimpleInterestTermsContractContract = /** @class */ (function (_super) {
    ...
    function SimpleInterestTermsContractContract(web3ContractInstance, defaults) {
        var _this = _super.call(this, web3ContractInstance, defaults) || this;
        _this.unpackParameters = {
        ...
        _this.getAmortizationUnitLengthInBlocks = {
            callAsync: function (amortizationUnitType, defaultBlock) {
                return __awaiter(this, void 0, void 0, function () {
                    var self, result;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
    ...
    SimpleInterestTermsContractContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = contracts_1.SimpleInterestTermsContract.abi, networks = contracts_1.SimpleInterestTermsContract.networks;
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            return [2 /*return*/, new SimpleInterestTermsContractContract(web3ContractInstance, defaults)];
                        }
                        else {
                            throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("SimpleInterestTermsContract", currentNetwork));
                        }
                        return [3 /*break*/, 4];
                    case 3: throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("SimpleInterestTermsContract", currentNetwork));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        web3Utils = new web3_utils_1.Web3Utils(web3);
                        abi = contracts_1.SimpleInterestTermsContract.abi;
    ...
    return SimpleInterestTermsContractContract;
...
//# sourceMappingURL=simple_interest_terms_contract_wrapper.js.map