...
var TokenTransferProxyContract = /** @class */ (function (_super) {
    ...
    function TokenTransferProxyContract(web3ContractInstance, defaults) {
        ...
        _this.addAuthorizedTransferAgent = {
            ...
            getABIEncodedTransactionData: function (_agent, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.addAuthorizedTransferAgent.getData();
                return abiEncodedTransactionData;
            },
        };
        _this.transferFrom = {
            sendTransactionAsync: function (_token, _from, _to, _amount, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
            ...
            estimateGasAsync: function (_token, _from, _to, _amount, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.transferFromAsync.estimateGas, self.web3ContractInstance)(_token, _from, _to, _amount, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (_token, _from, _to, _amount, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
        ...
        _this.revokeTransferAgentAuthorization = {
            sendTransactionAsync: function (_agent, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
            ...
            getABIEncodedTransactionData: function (_agent, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.revokeTransferAgentAuthorization.getData();
                return abiEncodedTransactionData;
            },
        };
        _this.getAuthorizedTransferAgents = {
            callAsync: function (defaultBlock) {
                return __awaiter(this, void 0, void 0, function () {
                    var self, result;
                    return __generator(this, function (_a) {
    ...
    TokenTransferProxyContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = contracts_1.TokenTransferProxy.abi, networks = contracts_1.TokenTransferProxy.networks;
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            return [2 /*return*/, new TokenTransferProxyContract(web3ContractInstance, defaults)];
                        }
                        else {
                            throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("TokenTransferProxy", currentNetwork));
                        }
                        return [3 /*break*/, 4];
                    case 3: throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("TokenTransferProxy", currentNetwork));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    TokenTransferProxyContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        web3Utils = new web3_utils_1.Web3Utils(web3);
                        abi = contracts_1.TokenTransferProxy.abi;
