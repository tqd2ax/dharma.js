...
var DummyTokenContract = /** @class */ (function (_super) {
    ...
    function DummyTokenContract(web3ContractInstance, defaults) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.transferFromAsync.estimateGas, self.web3ContractInstance)(_from, _to, _value, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
        ...
        _this.mint = {
            sendTransactionAsync: function (_to, _amount, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
            ...
            estimateGasAsync: function (_to, _amount, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
            ...
            getABIEncodedTransactionData: function (_to, _amount, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.mint.getData();
                return abiEncodedTransactionData;
            },
        };
        _this.decreaseApproval = {
            ...
            getABIEncodedTransactionData: function (_spender, _subtractedValue, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.decreaseApproval.getData();
                return abiEncodedTransactionData;
            },
        };
        _this.balanceOf = {
        ...
        _this.finishMinting = {
            ...
            getABIEncodedTransactionData: function (txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.finishMinting.getData();
                return abiEncodedTransactionData;
            },
        };
        _this.owner = {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.transferAsync.estimateGas, self.web3ContractInstance)(_to, _value, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
        ...
        _this.increaseApproval = {
            ...
            getABIEncodedTransactionData: function (_spender, _addedValue, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.increaseApproval.getData();
                return abiEncodedTransactionData;
            },
        };
        _this.allowance = {
    ...
    DummyTokenContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        abi = contracts_1.DummyToken.abi;
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            return [2 /*return*/, new DummyTokenContract(web3ContractInstance, defaults)];
                        }
                        else {
                            throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("DummyToken", currentNetwork));
                        }
                        return [2 /*return*/];
                }
            });
...
//# sourceMappingURL=dummy_token_wrapper.js.map