...
var RepaymentRouterContract = /** @class */ (function (_super) {
    ...
    function RepaymentRouterContract(web3ContractInstance, defaults) {
        ...
        _this.repayNFT = {
            sendTransactionAsync: function (agreementId, tokenId, tokenAddress, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.repayNFT.estimateGasAsync.bind(self, agreementId, tokenId, tokenAddress))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.repayNFT, self.web3ContractInstance)(agreementId, tokenId, tokenAddress, txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            estimateGasAsync: function (agreementId, tokenId, tokenAddress, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.repayNFT.estimateGas, self.web3ContractInstance)(agreementId, tokenId, tokenAddress, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (agreementId, tokenId, tokenAddress, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.repayNFT.getData();
                return abiEncodedTransactionData;
            },
        };
        ...
        _this.repay = {
            sendTransactionAsync: function (agreementId, amount, tokenAddress, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, txHash;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.repay.estimateGasAsync.bind(self, agreementId, amount, tokenAddress))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.repay, self.web3ContractInstance)(agreementId, amount, tokenAddress, txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
            ...
            estimateGasAsync: function (agreementId, amount, tokenAddress, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    var self, txDataWithDefaults, gas;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.repay.estimateGas, self.web3ContractInstance)(agreementId, amount, tokenAddress, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (agreementId, amount, tokenAddress, txData) {
                if (txData === void 0) { txData = {}; }
                var self = this;
                var abiEncodedTransactionData = self.web3ContractInstance.repay.getData();
                return abiEncodedTransactionData;
            },
        };
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = contracts_1.RepaymentRouter.abi, networks = contracts_1.RepaymentRouter.networks;
    ...
    RepaymentRouterContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        web3Utils = new web3_utils_1.Web3Utils(web3);
                        abi = contracts_1.RepaymentRouter.abi;
    ...
    return RepaymentRouterContract;
...
//# sourceMappingURL=repayment_router_wrapper.js.map