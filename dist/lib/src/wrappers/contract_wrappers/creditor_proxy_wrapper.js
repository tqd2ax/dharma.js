...
var CreditorProxyContract = /** @class */ (function (_super) {
    __extends(CreditorProxyContract, _super);
    function CreditorProxyContract(web3ContractInstance, defaults) {
        var _this = _super.call(this, web3ContractInstance, defaults) || this;
        _this.cancelDebtOffer = {
            sendTransactionAsync: function (commitmentAddresses, commitmentValues, termsContractParameters, txData) {
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.cancelDebtOffer.estimateGasAsync.bind(self, commitmentAddresses, commitmentValues, termsContractParameters))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.cancelDebtOffer, self.web3ContractInstance)(commitmentAddresses, commitmentValues, termsContractParameters, txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
            ...
            estimateGasAsync: function (commitmentAddresses, commitmentValues, termsContractParameters, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.cancelDebtOffer.estimateGas, self.web3ContractInstance)(commitmentAddresses, commitmentValues, termsContractParameters, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
            ...
            getABIEncodedTransactionData: function (commitmentAddresses, commitmentValues, termsContractParameters, txData) {
                if (txData === void 0) { txData = {}; }
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.cancelDebtOffer.getData, self.web3ContractInstance)(commitmentAddresses, commitmentValues, termsContractParameters, txDataWithDefaults)];
                            case 2:
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, self.applyDefaultsToTxDataAsync(txData, self.fillDebtOffer.estimateGasAsync.bind(self, creditor, orderAddresses, orderValues, orderBytes32, signaturesV, signaturesR, signaturesS))];
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.fillDebtOffer, self.web3ContractInstance)(creditor, orderAddresses, orderValues, orderBytes32, signaturesV, signaturesR, signaturesS, txDataWithDefaults)];
                            case 2:
                                txHash = _a.sent();
                                return [2 /*return*/, txHash];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.fillDebtOffer.estimateGas, self.web3ContractInstance)(creditor, orderAddresses, orderValues, orderBytes32, signaturesV, signaturesR, signaturesS, txDataWithDefaults)];
                            case 2:
                                gas = _a.sent();
                                return [2 /*return*/, gas];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            ...
                            case 1:
                                txDataWithDefaults = _a.sent();
                                return [4 /*yield*/, promisify(self.web3ContractInstance.fillDebtOffer.getData, self.web3ContractInstance)(creditor, orderAddresses, orderValues, orderBytes32, signaturesV, signaturesR, signaturesS, txDataWithDefaults)];
                            case 2:
                                abiEncodedTransactionData = _a.sent();
                                return [2 /*return*/, abiEncodedTransactionData];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, promisify(self.web3ContractInstance.debtOfferCancelled.call, self.web3ContractInstance)(index_0)];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, promisify(self.web3ContractInstance.debtOfferFilled.call, self.web3ContractInstance)(index_0)];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, promisify(self.web3ContractInstance.NULL_ISSUANCE_HASH.call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
                ...
                return __awaiter(this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                self = this;
                                return [4 /*yield*/, promisify(self.web3ContractInstance.EXTERNAL_QUERY_GAS_LIMIT.call, self.web3ContractInstance)()];
                            case 1:
                                result = _a.sent();
                                return [2 /*return*/, result];
                        }
    ...
    CreditorProxyContract.prototype.deploy = function () {
        var args = [];
    ...
    CreditorProxyContract.deployed = function (web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        abi = contracts_1.CreditorProxy.abi, networks = contracts_1.CreditorProxy.networks;
                    ...
                    case 2:
                        ...
                        if (contractExists) {
                            ...
                            return [2 /*return*/, new CreditorProxyContract(web3ContractInstance, defaults)];
                        }
                        else {
                            throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("CreditorProxy", currentNetwork));
                        }
                        return [3 /*break*/, 4];
                    case 3: throw new Error(base_contract_wrapper_1.CONTRACT_WRAPPER_ERRORS.CONTRACT_NOT_FOUND_ON_NETWORK("CreditorProxy", currentNetwork));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    CreditorProxyContract.at = function (address, web3, defaults) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        web3Utils = new web3_utils_1.Web3Utils(web3);
                        abi = contracts_1.CreditorProxy.abi;
...
exports.CreditorProxyContract = CreditorProxyContract;
//# sourceMappingURL=creditor_proxy_wrapper.js.map