...
exports.CollateralizerAdapterErrors = {
    ...
    INSUFFICIENT_COLLATERAL_TOKEN_BALANCE: function () {
        return "Debtor does not have sufficient balance required for collateral transfer.";
    },
...
var CollateralizedSimpleInterestLoanAdapter = /** @class */ (function () {
     ...
     * @returns {Promise<boolean>}
     */
    CollateralizedSimpleInterestLoanAdapter.prototype.isCollateralReturned = function (agreementId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
     ...
     * @returns {Promise<boolean>}
     */
    CollateralizedSimpleInterestLoanAdapter.prototype.isCollateralSeized = function (agreementId) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    CollateralizedSimpleInterestLoanAdapter.prototype.eventEmittedForAgreement = function (eventName, agreementId) {
        return __awaiter(this, void 0, void 0, function () {
            var contractRegistry, collateralizer, collateralizerAddress;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contractsAPI.loadContractRegistryAsync()];
                    case 1:
                        contractRegistry = _a.sent();
                        return [4 /*yield*/, this.contractsAPI.loadCollateralizerAsync()];
                    case 2:
                        collateralizer = _a.sent();
                        return [4 /*yield*/, contractRegistry.collateralizer.callAsync()];
                    case 3:
                        collateralizerAddress = _a.sent();
