...
exports.OrderAPIErrors = {
    ...
    INSUFFICIENT_COLLATERALIZER_BALANCE: function () {
        return singleLineString(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Debtor does not have sufficient balance required for collateral transfer."], ["Debtor does not have sufficient balance required for collateral transfer."])));
    },
};
var OrderAPI = /** @class */ (function () {
    ...
    OrderAPI.prototype.fillAsync = function (debtOrderData, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, transaction_utils_1.generateTxOptions(this.web3, ORDER_FILL_GAS_MAXIMUM, options)];
                    case 1:
                        txOptions = _a.sent();
                        return [4 /*yield*/, transaction_utils_1.applyNetworkDefaults(debtOrderData, this.contracts)];
                    case 2:
     ...
     */
    OrderAPI.prototype.acceptOffer = function (debtOrderData, options) {
        return __awaiter(this, void 0, void 0, function () {
            var txOptions, creditorProxy, debtOrderDataWrapper;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, transaction_utils_1.generateTxOptions(this.web3, ACCEPT_GAS_MAXIMUM, options)];
                    case 1:
                        txOptions = _a.sent();
                        return [4 /*yield*/, this.contracts.loadCreditorProxyContract()];
                    case 2:
                        creditorProxy = _a.sent();
                        debtOrderDataWrapper = new wrappers_1.DebtOrderDataWrapper(debtOrderData);
                        return [2 /*return*/, creditorProxy.fillDebtOffer.sendTransactionAsync(debtOrderDataWrapper.getCreditor(), debtOrderDataWrapper.getOrderAddresses(), debtOrderDataWrapper.getOrderValues(), debtOrderDataWrapper.getOrderBytes32(), debtOrderDataWrapper.getSignaturesV(), debtOrderDataWrapper.getSignaturesR(), debtOrderDataWrapper.getSignaturesS(), txOptions)];
                }
            });
        });
    };
     ...
     * @returns {Promise<void>}
     */
    OrderAPI.prototype.assertReadyToFill = function (debtOrderData, txOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, debtKernel, debtToken;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadDharmaContractsAsync(txOptions)];
                    case 1:
                        _a = _b.sent(), debtKernel = _a.debtKernel, debtToken = _a.debtToken;
                        return [4 /*yield*/, this.assertValidityInvariantsAsync(debtOrderData, debtKernel, debtToken)];
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, this.assert.order.validDebtorSignature(debtOrderData, txOptions, exports.OrderAPIErrors.INVALID_DEBTOR_SIGNATURE())];
                    case 3:
                        _b.sent();
                        if (!(debtOrderData.underwriter && debtOrderData.underwriter !== constants_1.NULL_ADDRESS)) return [3 /*break*/, 5];
                    ...
                    case 4:
                        _b.sent();
                        _b.label = 5;
                    case 5: return [4 /*yield*/, this.assertValidLoanTerms(debtOrderData)];
                    case 6:
                        _b.sent();
                        return [2 /*return*/];
                }
    ...
    OrderAPI.prototype.getIssuanceHash = function (debtOrderData) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, transaction_utils_1.applyNetworkDefaults(debtOrderData, this.contracts)];
                    case 1:
                        debtOrderData = _a.sent();
                        debtOrderDataWrapped = new wrappers_1.DebtOrderDataWrapper(debtOrderData);
     ...
     * @returns {Promise<void>}
     */
    OrderAPI.prototype.assertFillableBy = function (debtOrderData, prospectiveCreditor, txOptions) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.contracts.loadTokenTransferProxyAsync(txOptions)];
                    case 1:
                        tokenTransferProxy = _a.sent();
                        return [4 /*yield*/, Promise.all([
                                this.assertReadyToFill(debtOrderData, txOptions),
                                this.assertCreditorBalanceAndAllowanceInvariantsAsync(debtOrderData, tokenTransferProxy, txOptions),
                            ])];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
     ...
     * @returns {Promise<boolean>}
     */
    OrderAPI.prototype.isFillableBy = function (debtOrderData, prospectiveCreditor, txOptions) {
        return __awaiter(this, void 0, void 0, function () {
            var e_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.assertFillableBy(debtOrderData, prospectiveCreditor, txOptions)];
                    case 1:
                        _a.sent();
