...
exports.UNLIMITED_ALLOWANCE = new bignumber_1.BigNumber(2).pow(256).sub(1);
...
var TokenAPI = /** @class */ (function () {
     ...
     * @returns {boolean}
     */
    TokenAPI.isUnlimitedAllowance = function (allowance) {
        return allowance.greaterThanOrEqualTo(exports.UNLIMITED_ALLOWANCE);
    };
    /**
    ...
    TokenAPI.prototype.transferAsync = function (tokenAddress, to, value, options) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, transaction_utils_1.generateTxOptions(this.web3, TRANSFER_GAS_MAXIMUM, options)];
                    case 1:
                        txOptions = _a.sent();
     ...
     * @return              the hash of the resulting transaction.
     */
    TokenAPI.prototype.setUnlimitedCreditorProxyAllowanceAsync = function (tokenAddress, options) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, this.setCreditorProxyAllowanceAsync(tokenAddress, exports.UNLIMITED_ALLOWANCE, options)];
                }
            });
        });
    };
     ...
     * @return              the hash of the resulting transaction.
     */
    TokenAPI.prototype.setCreditorProxyAllowanceAsync = function (tokenAddress, allowance, options) {
        return __awaiter(this, void 0, void 0, function () {
            var txOptions, tokenContract, creditorProxyContract;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, transaction_utils_1.generateTxOptions(this.web3, TRANSFER_GAS_MAXIMUM, options)];
                    case 1:
                    ...
                    case 4:
                        ...
                        return [2 /*return*/, tokenContract.approve.sendTransactionAsync(creditorProxyContract.address, allowance, txOptions)];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2 /*return*/, this.setProxyAllowanceAsync(tokenAddress, exports.UNLIMITED_ALLOWANCE, options)];
                }
            });
        });
    };
     ...
     */
    TokenAPI.prototype.hasUnlimitedAllowance = function (tokenAddress, ownerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var existingAllowance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getProxyAllowanceAsync(tokenAddress, ownerAddress)];
                    case 1:
                        existingAllowance = _a.sent();
                        return [2 /*return*/, TokenAPI.isUnlimitedAllowance(existingAllowance)];
                }
            });
        });
    };
     ...
     */
    TokenAPI.prototype.getCreditorProxyAllowanceAsync = function (tokenAddress, ownerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenContract, creditorProxy;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadERC20TokenAsync(tokenAddress)];
                    case 1:
                    ...
                    case 3:
                        ...
                        return [2 /*return*/, tokenContract.allowance.callAsync(ownerAddress, creditorProxy.address)];
                }
            });
        });
    };
     ...
     * @returns {Promise<boolean>}
     */
    TokenAPI.prototype.hasUnlimitedCreditorProxyAllowance = function (tokenAddress, ownerAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var existingAllowance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getCreditorProxyAllowanceAsync(tokenAddress, ownerAddress)];
                    case 1:
                        existingAllowance = _a.sent();
                        return [2 /*return*/, TokenAPI.isUnlimitedAllowance(existingAllowance)];
                }
     ...
     */
    TokenAPI.prototype.getTokenAttributesBySymbol = function (symbol) {
        return __awaiter(this, void 0, void 0, function () {
            var tokenRegistry, _a, address, index, name, numDecimals;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, this.contracts.loadTokenRegistry()];
                    case 1:
                        tokenRegistry = _b.sent();
                        return [4 /*yield*/, tokenRegistry.getTokenAttributesBySymbol.callAsync(symbol)];
                    case 2:
                        _a = _b.sent(), address = _a[0], index = _a[1], name = _a[2], numDecimals = _a[3];
                        return [2 /*return*/, {
                                address: address,
                                symbol: symbol,
                                name: name,
    ...
    TokenAPI.prototype.getTokenSymbolByIndexAsync = function (index) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, tokenRegistryContract.getTokenSymbolByIndex.callAsync(index)];
                }
            });
        });
    };
