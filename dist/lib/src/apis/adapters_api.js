...
exports.AdaptersErrors = {
    NO_ADAPTER_FOR_TERMS_CONTRACT: function (termsContractAddress) {
        return singleLineString(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Could not find adapter suitable for terms contract at\n                         address ", "."], ["Could not find adapter suitable for terms contract at\n                         address ", "."])), termsContractAddress);
    },
};
var AdaptersAPI = /** @class */ (function () {
    function AdaptersAPI(web3, contractsApi) {
        this.contracts = contractsApi;
        this.simpleInterestLoan = new adapters_1.SimpleInterestLoanAdapter(web3, this.contracts);
        this.collateralizedSimpleInterestLoan = new adapters_1.CollateralizedSimpleInterestLoanAdapter(web3, this.contracts);
        this.erc721CollateralizedSimpleInterestLoan = new adapters_1.ERC721CollateralizedSimpleInterestLoanAdapter(web3, this.contracts);
    }
    AdaptersAPI.prototype.getAdapterByTermsContractAddress = function (termsContractAddress) {
        return __awaiter(this, void 0, void 0, function () {
            var termsContractType;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contracts.getTermsContractType(termsContractAddress)];
                    case 1:
