                    ...
                    case 1:
                        ...
                        switch (termsContractType) {
                            case constants_1.TERMS_CONTRACT_TYPES.COLLATERALIZED_SIMPLE_INTEREST_LOAN:
                                return [2 /*return*/, new adapters_1.CollateralizedSimpleInterestLoanAdapter(this.web3, this.contracts)];
                            case constants_1.TERMS_CONTRACT_TYPES.SIMPLE_INTEREST_LOAN:
                                return [2 /*return*/, new adapters_1.SimpleInterestLoanAdapter(this.web3, this.contracts)];
                        }
