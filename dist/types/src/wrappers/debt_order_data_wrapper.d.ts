...
import { DebtOrderData, IssuanceCommitment } from "../types";
/**
 * Decorate a given debt order with various higher level functions.
 */
export declare class DebtOrderDataWrapper {
    private debtOrderData;
    constructor(debtOrderData: DebtOrderData);
    /**
    ...
    getDebtOrderData(): DebtOrderData;
