...
export declare class MockERC721ReceiverContract extends BaseContract {
    getMockReturnValue: {
        callAsync(functionName: string, argsSignature: string, defaultBlock?: any): Promise<string>;
    };
    ...
    wasOnERC721ReceivedCalledWith: {
        callAsync(_address: string, _tokenId: BigNumber, _data: string, defaultBlock?: any): Promise<boolean>;
    };
    reset: {
