...
export declare class MintableERC721TokenContract extends BaseContract {
    supportsInterface: {
    ...
    static deployed(web3: Web3, defaults?: Partial<TxData>): Promise<MintableERC721TokenContract>;
    constructor(web3ContractInstance: Web3.ContractInstance, defaults: Partial<TxData>);
    static at(address: string, web3: Web3, defaults: Partial<TxData>): Promise<MintableERC721TokenContract>;
}
