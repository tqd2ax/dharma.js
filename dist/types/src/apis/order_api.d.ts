...
export declare class OrderAPI {
     ...
     */
    acceptOffer(debtOrderData: DebtOrderData, options?: TxData): Promise<string>;
    /**
     ...
     * @returns {Promise<void>}
     */
    assertReadyToFill(debtOrderData: DebtOrderData, txOptions?: TxData): Promise<void>;
    /**
     ...
     * @returns {Promise<void>}
     */
    assertFillableBy(debtOrderData: DebtOrderData, prospectiveCreditor: string, txOptions?: TxData): Promise<void>;
    /**
     ...
     * @returns {Promise<boolean>}
     */
    isFillableBy(debtOrderData: DebtOrderData, prospectiveCreditor: string, txOptions?: TxData): Promise<boolean>;
    /**
     ...
     * @returns {Promise<void>}
     */
    private assertValidLoanTerms;
    private assertValidityInvariantsAsync;
    private assertConsensualityInvariants;
    private assertCreditorBalanceAndAllowanceInvariantsAsync;
}
