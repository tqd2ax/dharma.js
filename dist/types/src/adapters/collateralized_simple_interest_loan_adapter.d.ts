...
export declare class CollateralizedSimpleInterestLoanAdapter implements Adapter {
    ...
    private assertTokenCorrespondsToSymbol;
    private assertIsCollateralizedSimpleInterestTermsContract;
    ...
    private assertDefaultedForGracePeriod;
    private defaultedForGracePeriod;
    private assertCollateralNotWithdrawn;
    private assertCollateralBalanceAndAllowanceInvariantsAsync;
    private debtRepaid;
