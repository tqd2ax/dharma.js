...
export declare class SchemaAssertions {
    ...
    bytes(variableName: string, value: any): void;
    number(variableName: string, value: any): void;
    wholeNumber(variableName: string, value: any): void;
    simpleInterestLoanOrder(variableName: string, value: any): void;
    collateralizedSimpleInterestLoanOrder(variableName: string, value: any): void;
    erc721CollateralizedSimpleInterestLoanOrder(variableName: string, value: any): void;
