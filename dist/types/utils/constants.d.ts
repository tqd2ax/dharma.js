...
export declare const SALT_DECIMALS = 20;
/**
...
export declare const CONTRACT_REGISTRY_CONTRACT_CACHE_KEY = "ContractRegistry";
...
export declare const ERC721_COLLATERALIZER_CONTRACT_CACHE_KEY = "ERC721CollateralizerContract";
export declare const ERC721_COLLATERALIZED_SIMPLE_INTEREST_TERMS_CONTRACT_CACHE_KEY = "ERC721CollateralizedSimpleInterestTermsContract";
export declare const ERC721_TOKEN_REGISTRY_CONTRACT_CACHE_KEY = "ERC721TokenRegistryContract";
export declare const CREDITOR_PROXY_CONTRACT_CACHE_KEY = "CreditorProxyContract";
export declare const TERMS_CONTRACT_TYPES: {
    COLLATERALIZED_SIMPLE_INTEREST_LOAN: string;
    SIMPLE_INTEREST_LOAN: string;
    ERC721_COLLATERALIZED_SIMPLE_INTEREST_LOAN: string;
};
